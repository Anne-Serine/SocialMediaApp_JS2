export function postTemplate(post, userName) {
  ...
  const { created, title, body, id, author, media, tags} = post;
  ...
  return `<div class="container card image-card p-3 d-flex justify-content-center mb-2" id="postTemplateCard">
            <div class="row mb-2">
              <div class="col col-xl-10 d-flex align-items-center gap-2">
                ...
                <p class="h5 text-secondary m-0">@${author.name}</p>
              </div>
                ...
                ${userName === author.name ? 
                  `<div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end p-2">
                      <button value=${id} class="btn btn-outline-dark border-0 d-flex gap-1 align-items-center" data-post-id="${post.id}"><i class="fa-solid fa-pen"></i>Edit</button>
                      <button value=${id} class="btn btn-outline-danger border-0 d-flex gap-1 align-items-center" data-delete-post-id="${post.id}"><i class="fa-solid fa-trash"></i>Delete</button>
                    </div>
                  </div>`
                  : ""
                }
            ...
            <div class="row mb-2">
              ${media ? `<img src="${media.url}" class="img-fluid w-100" alt="${media.alt}">` : ""}
            </div>
            <div class="row">
            ...
            <div class="d-flex gap-3">
              <div class="justify-content-start disabled">
              ...
              <div class="d-flex justify-content-end">
                <a href="#" value=${id} class="me-2 link-underline link-underline-opacity-0" data-view-post-id="${post.id}">View post</a>
              </div>
            </div>
            
            <div class="container row mt-3 d-flex align-items-center justify-content-between">
              <textarea class="col-10 border p-2 rounded outline-none" placeholder="Add a comment..." disabled></textarea>
